...
const involvedModelName = "audit_trail";
const title = "Entry Logs";
const selectedKey = "entry_audit_trail";
const tableIDName = "ptx_id";
const { Paragraph, Text } = Typography;

const EntryAuditTrail = (props) => {
  ...
  const getAllData = async () => {
    let dataList = [];
    try {
      let url = `/api/entry/${involvedModelName}/all`;
...
export default EntryAuditTrail;
